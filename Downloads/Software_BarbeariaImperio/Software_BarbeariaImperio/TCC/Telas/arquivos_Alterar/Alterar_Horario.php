...
<html lang="pt-br">
  <head>
    ...
    <title>Alteração de Horário</title>
  </head>
  <body>
  ...
  cod_Cliente = '$cod_Cliente', Data_Servico='$data', Horario_Servico='$horario', valor_total='$valor', Descricao_Corte='$feito', Cod_Funcionario='$cod_func', metodo_pagamento='$cod_pag', tags='$tags_str' where id_Servico='$id_servico'";
