...
$comandoSql="select * from tb_Produto where id_Produto='$id_prod'";
...
$estoque=$dados["Quantidade_Estoque"];
...
<!-- imagem de fundo -->
  ...
  <div class="container-flex">
    ...
    <div class="centro-quadrado-geral">                        <!-- div feita para colocar elementos no meio do quadrado-->
         ...
         <h1 class="texto_grande">Estoque do produto <?php echo $nome ?></h1>
         <div class="botao-superior-direito">    <?php 
 
 echo"<a href='http://localhost/TCC/Telas/Estoque/ListagemProdutosEstoque.php'><img src='http://localhost/TCC/imagens/seta.png'></a>";

?></div>
         <div class="textos_cima_label">
        
         <form action="Alterar_Produto.php" method="POST" id="formCadastroProduto">
          <!-- inicio do formulario de cadastro do horario do atendimento-->
       

          <input type="text" class="form-control d-none" id="idProduto" name="idProduto"
                  placeholder="idProduto" value="<?php echo $id_prod?>" readonly>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              <div class="input-control">
                ...
                <input type="text" class="form-control" id="NomeProduto" name="NomeProduto"
                  placeholder="Nome do produto" value="<?php echo $nome?>">
                <div class="error"></div>
              </div>
            </div>
            ...
            <div class="form-group col-md-4">
              <div class="input-control">
                <label for="EstoqueInicial">Quantidade em estoque</label>
                <input type="text" class="form-control" id="EstoqueInicial" name="EstoqueInicial"
                  placeholder="Quantidade inicial em estoque" value="<?php echo $estoque?>">
                <div class="error"></div>
              </div>
            </div>
            ...
            <div class="form-group col-md-2">
              <div class="input-control">
                ...
                <input type="text" class="form-control" id="ValorUnitario" name="ValorUnitario" placeholder="Valor da unidade do produto" value="<?php echo formatarValor($valor)?>">
                <div class="error"></div>
              </div>
            </div>
            ...
            <div class="form-group col-md">
              <div class="input-control">
                ...
                <input type="text" class="form-control" id="DescricaoProduto" name="DescricaoProduto"
                  placeholder="Descrição do produto" value="<?php echo $descricao?>">
                <div class="error"></div>
              </div>
            </div>
...
<div style="text-align:left"> 
          <input type="submit" value="Cadastrar" class="btn btn-outline-success sub" id="botaoCadastro"></div>
 ...
 <!-- Não mexer, essencial para o bootstrap funcionar-->
  ...
  <script>
    $('#ValorUnitario').mask('00.00', { reverse: true });  //codigo para adicionar a mascara nos campos, ja serve como validação pois impede add de letras.
