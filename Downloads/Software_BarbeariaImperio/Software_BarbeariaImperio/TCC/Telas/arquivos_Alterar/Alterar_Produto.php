...
<html lang="pt-br">
  ...
  <body>
   ...
   <div class="container">
    ...
    $nome=ucfirst($_POST["NomeProduto"]);
    $estoque=$_POST["EstoqueInicial"];
    $valor=$_POST["ValorUnitario"];
    $descricao=ucfirst($_POST["DescricaoProduto"]);
   

    /*3- criando o comando sql para alteracao do registro */
	$comandoSql="update tb_produto set
  nome_produto = '$nome', quantidade_estoque='$estoque', valor_unitario='$valor', descricao_produto='$descricao'  where id_produto='$id_prod'";
    ...
    header('Location: ../Estoque/ListagemProdutosEstoque.php');
