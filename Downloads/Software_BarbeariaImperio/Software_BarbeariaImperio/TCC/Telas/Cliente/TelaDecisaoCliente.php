...
<style>
 ...
 <!-- Começo quadrado -->
     <div class="quadrado-arredondado">           <!-- div do quadrrado preto de fundo-->
  ...
  ?></div>
             ...
             <a href="Frm_Cadastro_Novo_Cliente.php"><button type="button" class="btn btn-outline-light  buttonadm2">NOVO CLIENTE</button></a> <!--não vão ter dois botoes, mas ate descobrir como fazer só um vai dois por enquanto-->
            <br>
             <a href="ListagemClientes.php"><button type="button" class="btn btn-outline-light  buttonadm2">LISTAGEM DE CLIENTES</button></a>
        </div>
