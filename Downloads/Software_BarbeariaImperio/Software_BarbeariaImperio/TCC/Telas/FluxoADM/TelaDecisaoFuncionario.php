...
<style>
 ...
 <!-- Começo quadrado -->
     <div class="quadrado-arredondado">           <!-- div do quadrado preto de fundo-->
  ...
  ?></div>
        ...
        <a href="Frm_Cadastro_Novo_Funcionario.php">
        <button type="button" class="btn btn-outline-light buttonadm2">NOVO FUNCIONARIO</button>
    </a>
    <a href="ListagemFuncionariosAtivos.php">
        <button type="button" class="btn btn-outline-light buttonadm2">FUNCIONARIOS ATIVOS</button>
    </a>
        </div>
