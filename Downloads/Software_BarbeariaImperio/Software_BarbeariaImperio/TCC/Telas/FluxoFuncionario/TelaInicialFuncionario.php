...
<body>
        ...
        <div style="display: flex; align-items: center;">
            ...
            <div class="btn-group">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" type="button" href="../FluxoADM/TelaPerfil.php">Perfil</a>
    ...
    <div class="quadrado-arredondado-geral">
        <div class="centro-quadrado-fino">
            <a href="../FluxoADM/Agendamento_Horario.php"><button type="button" class="buttonadm btn btn-outline-light">AGENDAR
                    HORARIO</button></a>
                        ...
                        return $valor;
                            ...
                            try{
                                ...
                                if($conn){
                                    ...
                                    WHERE s.status=1 and cod_funcionario = '.$id_func.' order by data_servico');
                                    $query->execute();
    ...
    <script> //script chama php complementar, que faz uma varredura no banco a procura de entidades com nome parecido
        ...
        elementoProcurado2.addEventListener('keyup', () => {
            ...
            fetch(` http://localhost/TCC/Telas/phpComplementar/inicialFUNCprocuraCliente.php?cliente=${value}`)
        ...
        elementoProcurado3.addEventListener('change', () => {
            ...
            console.log(value);
            fetch(` http://localhost/TCC/Telas/phpComplementar/inicialFUNCprocuraData.php?cliente=${value}`)
                .then(response => response.json())
                .then(results => {
                    let resultsHTML = "<div class='table-container'> <table>  <thead class='head2'> <tr><th>Barbeiro</th><th>Cliente</th><th>Data</th><th>Horário</th><th>Total</th><th>Alterar</th><th>Baixa</th></tr></thead><tbody class='scrollable-tbody'>";  results.forEach(item => {
                        resultsHTML += `  
